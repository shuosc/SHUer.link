  ...
  <div class="container">
    <div class="pure-g">
      ...
      <div class="pure-u-22-24 pure-u-md-3-5">
        ...
        <div class="search">
          <mu-icon :value="icon" @click.native="onIconClick" style="cursor:pointer;"/>
          <mu-icon-menu icon=":iconfont icon-more" :autoWidth="true" :maxHeight="300" @change="changeSearchEngine" ref="menu">
          ...
          <mu-text-field hintText="请输入搜索内容" label="搜索" v-model="searchString" @keyup.native.enter="searchContent" labelFloat fullWidth :required="true" />
        </div>
        <mu-raised-button class="search-button" label="搜索" icon=":iconfont icon-search" secondary @click="searchContent" />
      </div>
      <div class="pure-u-1-24 pure-u-md-1-5"></div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    onIconClick: function () {
      console.log(this.$refs.menu.handleOpen())
    },
